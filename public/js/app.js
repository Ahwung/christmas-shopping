...
app.controller("MyController", [
    ...
    function($http, $scope) {
        ...
        this.editItem = function(item) {
            ...
            if (this.updateRecipient === "") {
                this.updateRecipient = item.recipient;
            }
            if (this.updateRecipientCategory === "") {
                this.updateRecipientCategory = item.recipientCategory;
            }
            if (this.updatePrice === "") {
            ...
            if (this.updateStoreName === "") {
                this.updateStoreName = item.storeName;
            }
            if (this.updateStoreUrl === "") {
                this.updateStoreUrl = item.storeUrl;
            }
            if (this.updatePriority === "") {
                this.updatePriority = item.priority;
            }
            if (this.updateNotes === "") {
                this.updateNotes = item.notes;
            }
        ...
        this.getWishlist = function() {
            $http({
                ...
                response.data.forEach(
                    obj =>
                        (obj.recipientCategory = obj.recipientCategory.toLowerCase())
                );
                ...
                for (var i = 0; i < this.wishlist.length; i++) {
                    ...
                    this.recipientCategoryArray.push(
                        this.wishlist[i].recipientCategory
                    );
                }
                ...
                this.uniqueRecipientCategory = [
                    ...new Set(this.recipientCategoryArray)
                ].sort();
